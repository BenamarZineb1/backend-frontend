    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "20px", marginTop: "20px" }}>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.actions}>
            <button onClick={() => togglePublish("sujets")} style={published.sujets ? styles.btnRevoke : styles.btnPublish}>
              {published.sujets ? <><FaLock /> Retirer</> : <><FaBullhorn /> Publier</>}
            </button>
          </div>
        </div>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.actions}>
             <button style={styles.btnDownload}><FaDownload /> PDF</button>
...
const styles = {
  ...
  cardTitle: { color: "#003366", margin: "0 0 10px 0" },
  desc: { fontSize: "13px", color: "#666", flex: 1 },
  statusBox: (active) => ({
    margin: "15px auto", padding: "5px 15px", borderRadius: "20px", fontSize: "12px", fontWeight: "bold",
  ...
  btnPublish: { background: "#003366", color: "#fff", border: "none", padding: "8px 15px", borderRadius: "4px", cursor: "pointer", display: "flex", alignItems: "center", gap: "5px" },
  btnRevoke: { background: "#dc3545", color: "#fff", border: "none", padding: "8px 15px", borderRadius: "4px", cursor: "pointer", display: "flex", alignItems: "center", gap: "5px" },
  btnDownload: { background: "#6c757d", color: "#fff", border: "none", padding: "8px 15px", borderRadius: "4px", cursor: "pointer", display: "flex", alignItems: "center", gap: "5px" }
};