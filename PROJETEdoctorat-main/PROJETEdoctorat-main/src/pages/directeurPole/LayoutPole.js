...
import { FaBook, FaUserGraduate, FaCalendarAlt, FaBullhorn, FaFileSignature, FaSignOutAlt, FaUniversity } from "react-icons/fa";

export default function LayoutPole() {
  ...
  const menuItems = [
    { path: "/pole/sujets", label: "Sujets & Professeurs", icon: <FaBook /> },
    { path: "/pole/candidats", label: "Candidats", icon: <FaUserGraduate /> },
    { path: "/pole/calendrier", label: "Calendrier", icon: <FaCalendarAlt /> },
    { path: "/pole/communiquer", label: "Communiquer / Publier", icon: <FaBullhorn /> },
    { path: "/pole/inscription", label: "Inscriptions Finales", icon: <FaFileSignature /> },
  ];
    ...
    <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "#f4f6f9" }}>
      ...
      <aside style={{ width: "260px", backgroundColor: "#fff", borderRight: "1px solid #ddd", position: "fixed", height: "100vh", zIndex: 100 }}>
        <div style={{ padding: "20px", borderBottom: "1px solid #eee", textAlign: "center", background: "#f8f9fa" }}>
          ...
          <h3 style={{ color: "#003366", margin: "10px 0 5px", fontSize: "16px" }}>Pôle Doctoral</h3>
          <p style={{ color: "#666", fontSize: "12px", margin: 0 }}>Directeur: {user?.nom || "Admin"}</p>
        </div>
