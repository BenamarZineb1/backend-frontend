...
import { FaUserCheck, FaFileSignature, FaSearch, FaSignOutAlt, FaUniversity, FaClipboardList } from "react-icons/fa";

export default function LayoutScolarite() {
  ...
  const menuItems = [
    { path: "/scolarite/validation", label: "Validation Candidatures", icon: <FaUserCheck /> },
    { path: "/scolarite/inscriptions", label: "Inscriptions Finales", icon: <FaFileSignature /> },
    { path: "/scolarite/recherche", label: "Recherche & Sujets", icon: <FaSearch /> },
    { path: "/scolarite/documents", label: "Documents & Reçus", icon: <FaClipboardList /> },
  ];
    ...
    <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "#f4f6f9" }}>
      ...
      <aside style={{ width: "260px", backgroundColor: "#fff", borderRight: "1px solid #ddd", position: "fixed", height: "100vh", zIndex: 100 }}>
        <div style={{ padding: "20px", borderBottom: "1px solid #eee", textAlign: "center", background: "#f8f9fa" }}>
          ...
          <h3 style={{ color: "#003366", margin: "10px 0 5px", fontSize: "16px" }}>Service Scolarité</h3>
          <p style={{ color: "#666", fontSize: "12px", margin: 0 }}>Université SMBA</p>
        </div>
      ...
      <main style={{ marginLeft: "260px", flex: 1, display: "flex", flexDirection: "column" }}>
        <header style={{ height: "60px", background: "#fff", padding: "0 30px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #ddd", position: "sticky", top: 0, zIndex: 90 }}>
          <span style={{ fontWeight: "700", color: "#003366", fontSize: "18px" }}>Gestion des Doctorats - Admin</span>
